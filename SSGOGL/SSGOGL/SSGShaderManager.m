...
static unsigned int lastProgramUsed; //keeps track of last program used to minimize program switching

@interface SSGShaderManager()
...
@implementation SSGShaderManager
